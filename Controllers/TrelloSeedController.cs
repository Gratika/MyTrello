...
{
    public class TrelloSeedController : Controller
    {
      ...
      // RoleManager<IdentityRole> roleManager;
       /// ApplicationDbContext dbContext;
        public TrelloSeedController(UserManager<User> userManager,
          RoleManager<IdentityRole> roleManager,
          ApplicationDbContext dbContext)
        {
            //this.userManager = userManager;
            //this.roleManager = roleManager;
            CreateSeed(userManager, roleManager, dbContext);
        }

      public async void CreateSeed(UserManager<User> userManager, 
          RoleManager<IdentityRole> roleManager, 
          ApplicationDbContext dbContext)
        {
